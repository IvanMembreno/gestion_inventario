...
-- CreateIndex
CREATE INDEX "Shelf_branchId_idx" ON "Shelf"("branchId");

-- CreateIndex
CREATE UNIQUE INDEX "Shelf_name_branchId_key" ON "Shelf"("name", "branchId");

-- CreateIndex
CREATE INDEX "ShelfSlot_shelfId_idx" ON "ShelfSlot"("shelfId");

-- CreateIndex
CREATE UNIQUE INDEX "ShelfSlot_code_shelfId_key" ON "ShelfSlot"("code", "shelfId");
...
-- AddForeignKey
ALTER TABLE "BranchProduct" ADD CONSTRAINT "BranchProduct_shelfSlotId_fkey" FOREIGN KEY ("shelfSlotId") REFERENCES "ShelfSlot"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Shelf" ADD CONSTRAINT "Shelf_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
